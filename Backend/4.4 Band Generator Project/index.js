...
app.post("/submit", (req, res) => {
  ...
  let randomAdjNumber = Math.floor(Math.random() * adjLength) + 1;  
  let randomNounNumber = Math.floor(Math.random() * nounLength) + 1;

  let randomAdjective = adj[randomAdjNumber]
  let randomNoun = noun[randomNounNumber]
